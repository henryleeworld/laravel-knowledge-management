    ...
    <div class="row">
        <div class="breadcrumb-container">
            <ol class="breadcrumb">
                ...
                <li class="active">標籤：{{ $tag->name }}</li>
            </ol>
        </div>

        <div class="fb-heading">
            <i class="fa fa-folder"></i> 標籤：{{ $tag->name }}
        ...
        @foreach($articles as $article)
            <div class="panel panel-default">
                ...
                <div class="article-read-more">
                    <a href="{{ route('articles.show', [$article->slug, $article->id]) }}" class="btn btn-default btn-wide">閱讀更多...</a>
                </div>
            </div>
        @endforeach
